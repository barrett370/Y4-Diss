...
\end{turn}
\caption{\label{fig:bezIntIllustration} Illustration of Bezier Intersection recursive subdivision method (Recursion depth =6)}
\end{figure}\todo{Move to appendix?}
...
This problem is solved using the algorithm seen in Algorithm~\ref{alg:pathgrouping}\todo{do I need to make it more obvious that these algorithms are my own work?}
