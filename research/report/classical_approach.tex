...
In the above form the descriptions of genetic operators found in Section~\ref{subsec:GAOps} should be sufficiently detailed to re-implement.\todo[inline]{Phrasing?  Correct? should I elaborate? Could talk more about implementation for GA operators, design decisions etc. Ready to talk about performance in next section}
...
\end{figure}\todo{Remove hand-drawn figure and move descriptions to paragraph instead of caption}\todo{Technically this has very slightly changed in implementation, is it worth redoing or just leave as is?}
...
This is a malleable definition allowing for a lot of information to encapsulated whilst maintaining an abstract canonical description compatible with a swathe of mathematics through graph theory.\todo[inline]{wordy?}
...
This process is a wrapper around the previously implemented parallel planner described in~\ref{sec:maa}. It follows the algorithm outlined in Algorithm
