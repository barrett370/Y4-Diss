...
This problem is solved using my algorithm seen in Algorithm~\ref{alg:pathgrouping}\feedback{do I need to make it more obvious that these algorithms are my own work? Are they clear enough?}
...
This process is a wrapper around the previously implemented parallel planner described in Section~\ref{sec:maa}. It follows my algorithm outlined in Algorithm~\ref{alg:mrp}.\todo{give explanation in words}
