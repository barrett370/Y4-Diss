        ...
        \probleminput{ 
            \begin{itemize}
                \item A road system $\mathcal{R}$ represented as a graph $G = (V,E)$ 
                    ...
                    Where each edge $e \in E$ is a section of road defined as the space between two vertices $V^1,V^2 \in V$ which is bounded by two functions $b_1(x)$ and $b_2(x)$ augmented by a set of obstacles $O$ representing infeasible sections of road space
