...
My first step in cooperative route planning was to implement the functionality to allow me to check if two given routes intersect. This at the least will be a useful safety function and may well form the basis of my new fitness function\todo[inline]{refer to different methods of checking for Bézier curve intersection. No complete method, only approximations.}
