...
\begin{figure}[ht]
  \centering
  \includegraphics[scale=0.55]{figures/ifspace.jpg}
  \caption{\label{fig:ifspace-illustration} Illustration of finding infeasible section of curve}
\end{figure}\todo{replace with plotted/ computer designed version}
...
\begin{enumerate}
  ...
  \item I instead instituted a simpler heuristic using bounded boxes. Using the \texttt{Luxor} library \todo{cite?} I was able to detect whether two bounded boxes intersected, if they did not, futher checks can be skipped.\todo{Merge these first 2? }
