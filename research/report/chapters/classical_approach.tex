...
My for my initial implementation, I focused on simply getting a working system. I therefore, started by implementing the simplest form of each genetic operator. Namely, fitness proportional selection (aka. roulette wheel selection\todo[inline]{check this}), simple crossover and uniform mutation. (\ref{imp:FitPropSel})
