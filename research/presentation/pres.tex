...
\begin{frame}
    ...
    \note{
        ...
        For such a system as I am proposing to exist, it would require extensive government support. They would be required to mandate that all vehicles registered on the road after a certain date be compatible with a standard routing protocol.
