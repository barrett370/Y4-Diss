...
\begin{frame}
    ...
    \note{
        \begin{itemize}
            \item From a more practical perspective: 
            \item For such a system as I am proposing to exist, it would require extensive government support. 
            \item They would be required to mandate that all vehicles registered on the road after a certain date be compatible with a standard routing protocol.
            \item All routing systems must also be connected to a central routing system, allowing for high level route plans to be distributed to all agents in the network.
